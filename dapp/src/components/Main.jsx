...
export default function Main({ network, voteAccount }) {
  ...
  useEffect(() => {
    ...
    async function getVotes() {
      ...
      try {
        ...
        setVotes({
          approve: parseInt(account.approve.toString()),
          deny: parseInt(account.deny.toString()),
        });
      } catch (error) {
  ...
  // Vote for either Approve or Deny. Poll for updated vote count on completion
      ...
      <Box flex="1 0 auto">
        ...
        <Container>
          <Grid container spacing={3}>
            ...
            <Grid item xs={6}>
              <VoteOption side="Approve" handleVote={handleVote} />
            </Grid>
            <Grid item xs={6}>
              <VoteOption side="Deny" handleVote={handleVote} />
            </Grid>
            <Grid item xs={12}>
